...
model.add(keras.layers.Conv2D(32, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))  
model.add(keras.layers.Conv2D(32, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))
model.add(keras.layers.Conv2D(32, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))  
model.add(keras.layers.Conv2D(48, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))
model.add(keras.layers.Conv2D(48, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))
model.add(keras.layers.MaxPool2D(pool_size=(2, 2)))   #最大池化
model.add(keras.layers.Dropout(0.25))                 #防止過擬合
model.add(keras.layers.Conv2D(80, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))  
model.add(keras.layers.Conv2D(80, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))  
model.add(keras.layers.Conv2D(80, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))  
model.add(keras.layers.Conv2D(80, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))  
model.add(keras.layers.Conv2D(80, padding='same',activation=tf.nn.relu, kernel_size=(3, 3), input_shape=x_train.shape[1:]))  
